# Original architecture and migration plan (historical)

> Archived on 2026-09-23. This is the original 2026-09-21 plan with its later
> incremental annotations, not the current implementation contract. M1–M5
> status, API examples and future work below are historical; do not use them
> to infer today's capabilities. See [current architecture](../architecture.md).

Core boundary: [Transcript projection contract](../contracts/transcript-projection.md)
...
Current parameter-binding extension (at the time): [Observation views contract](observation-view-contract-20260922.md).
